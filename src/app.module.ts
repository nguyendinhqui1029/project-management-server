  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
          ...
          dropSchema: true, // ⚠️ Chỉ bật khi DEV, PROD thì tắt
          extra: {
            ssl: false,
    ...
    TypeOrmModule.forFeature([
      ...
      TicketEntity, MeetingEntity,
      PlanningDocumentEntity, PlanningDescriptionEntity,
      PlanningDocumentVersionEntity, TicketBoardEntity, SprintEntity,
      SprintRetroEntity, SprintPlanningEntity, RetroItemEntity
    ]),
  ],
