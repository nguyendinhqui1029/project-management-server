...
import { CreatePlanningDocumentVersionBodyDto, UpdatePlanningDocumentVersionBodyDto } from '@dto/planning-document-version.dto';
...
export class PlanningDocumentController {
    ...
    @Put('description/:id')
    updatePlanningDocumentDescription(@Param('id') id: number, @Body() body: UpdatePlanningDescriptionBodyDto) {
    ...
    @Put('version/:id')
    updatePlanningDocumentVersion(@Param('id') id: number, @Body() body: UpdatePlanningDocumentVersionBodyDto) {
